...
class PySSC:
	def __init__(self):
		if sys.platform == 'win32' or sys.platform == 'cygwin':
			self.pdll = CDLL("/Users/Avery/Desktop/Energy_Project/ssc.dll") 
		elif sys.platform == 'darwin':
			self.pdll = CDLL("/Users/Avery/Desktop/Energy_Project/ssc.dylib") 
		elif sys.platform == 'linux2':
			self.pdll = CDLL('/Users/Avery/Desktop/Energy_Project/ssc.so')   # instead of relative path, require user to have on LD_LIBRARY_PATH
		else:
